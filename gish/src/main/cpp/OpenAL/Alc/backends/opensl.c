...
static const char *res_str(SLresult result)
{
    switch(result)
    {
        ...
        case ((SLuint32) 0x00000011): return "ReadOnly";
        case ((SLuint32) 0x00000012): return "Engine option unsupported";
        case ((SLuint32) 0x00000013): return "Source/Sink incompatible";
    }
...
static ALCboolean opensl_reset_playback(ALCdevice *Device)
{
    ...
    format_pcm.endianness = (__BYTE_ORDER == __LITTLE_ENDIAN) ? SL_BYTEORDER_LITTLEENDIAN : SL_BYTEORDER_BIGENDIAN;
